...
plot(PCA$x[ ,1], PCA$x[ , 2], pch = 19, col = colors, main = "Colored by Treatment", xlab = "PCA
1", ylab = "PCA2")
legend("topright", legend = c("uninfected", "infected"), pch = 16, col = c('#FA8633', 'lightseagreen'), bty = "n")
```
```{r}
