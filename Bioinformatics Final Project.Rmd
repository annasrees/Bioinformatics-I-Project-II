...
#show top pathway
#plot_KEGG_up <- 
  hyp_dots(hyp_KEGG_up, title="KEGG Pathways Upregulated in Infected Mice", abrv=50, val = "fdr")
...
#plot_KEGG_down <- 
hyp_dots(hyp_KEGG_down, title="KEGG Pathways Downregulated in Infected Mice", abrv=50, val = "fdr")
